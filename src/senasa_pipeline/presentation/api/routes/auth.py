...
def ensure_session() -> dict[str, str | None]:  # type: ignore[misc]
    ...
    # Consumer con credenciales AFIP para login inline en OIDC si hiciera falta
    consumer = SenasaLoginConsumer(http=http, cuit=settings.afip_cuit, password=os.getenv("AFIP_PASSWORD", ""))
